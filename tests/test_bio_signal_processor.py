...
def test_heart_rate_within_baseline_bounds(processor: BioSignalProcessor, start_time: datetime, baseline) -> None:
...
def test_heart_rate_raises_on_non_positive_samples(processor: BioSignalProcessor, start_time: datetime) -> None:
    with pytest.raises(ValueError):
        processor.generate_synthetic_heart_rate(0, start_time)


def test_hrv_shape_and_bounds(processor: BioSignalProcessor, start_time: datetime, baseline) -> None:
...
def test_sleep_shape_and_bounds(processor: BioSignalProcessor, start_time: datetime, baseline) -> None:
...
def test_sleep_raises_on_non_positive_days(processor: BioSignalProcessor, start_time: datetime) -> None:
    with pytest.raises(ValueError):
        processor.generate_synthetic_sleep_data(0, start_time.date())


def test_environmental_exposure_shape_and_bounds(processor: BioSignalProcessor, start_time: datetime, baseline) -> None:
...
def test_process_biometric_data_adds_smoothed_column(processor: BioSignalProcessor, start_time: datetime) -> None:
...
def test_process_biometric_data_raises_on_missing_column(processor: BioSignalProcessor, start_time: datetime) -> None:
    raw = processor.generate_synthetic_heart_rate(10, start_time)
    with pytest.raises(ValueError):
        processor.process_biometric_data(raw, "does_not_exist")


def test_process_biometric_data_clips_extreme_outlier(processor: BioSignalProcessor, start_time: datetime) -> None:
    raw = processor.generate_synthetic_heart_rate(30, start_time)
...
def test_process_biometric_data_does_not_mutate_input(processor: BioSignalProcessor, start_time: datetime) -> None:
