...
- Focusing on what is best not just for us as individuals, but for the
  overall community and the research the project supports
...
- Presenting VitaGraph's synthetic research outputs as validated medical
  or clinical fact, in bad faith, after being corrected
...
pull requests, discussions, and any other official communication
...
[`SECURITY.md`](SECURITY.md#reporting-a-vulnerability) (use `[CONDUCT]` in
the subject line instead of `[SECURITY]`), or via a private message to
[`@Ciprian-LocalPulse`](https://github.com/Ciprian-LocalPulse) on GitHub.
